...
const resortSteps: BlueprintStep[] = [
  {
    ...
    time: "Night",
    title: "Departure",
    desc: ["Depart from here by Volvo bus."],
    side: "right",
  ...
  },
  {
    ...
    desc: [
      "Arrive in the morning and check in to hotel.",
      "Breakfast at hotel.",
...
const adventureSteps: BlueprintStep[] = [
  ...
  },
  {
    ...
    title: "Trek + Camp",
    desc: [
      "Arrive in the morning and have breakfast.",
      "Start trekking – enjoy beautiful views and waterfalls.",
      "Reach campsite and set up camp under the stars.",
      "Dinner at campsite.",
      "Activities: bonfire, making new friends, photography, and fun activities.",
      "Overnight stay in camp.",
    ],
