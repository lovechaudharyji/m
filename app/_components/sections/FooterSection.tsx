  ...
  return (
    <footer className="border-t border-border bg-background">
      <div className="mx-auto w-full max-w-6xl px-5 py-12">
        <Reveal className="grid gap-10 md:grid-cols-3 md:items-start">
          <div>
        ...
        <Reveal delayMs={120} className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-border pt-6 text-xs font-semibold text-foreground/60 sm:flex-row">
