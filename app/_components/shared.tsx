          ...
          <div className="mx-auto w-full max-w-6xl px-5">
            <div className="flex h-20 items-center justify-between">
              ...
              <div className="flex gap-2">
                <div className="h-11 w-11 animate-pulse rounded-2xl bg-white/10 md:hidden" />
                <div className="hidden h-10 w-56 animate-pulse rounded-full bg-white/10 md:block" />
                <div className="hidden h-10 w-40 animate-pulse rounded-full bg-white/10 md:block" />
              </div>
            </div>
